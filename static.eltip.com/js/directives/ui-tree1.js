    ...
    return {
        ...
        link: function ($scope, element, attrs, ngModel) {
            ...
            var zNodes =[
                ...
                { id:11, pId:1, name:"示波器",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:12, pId:1, name:"电阻",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:13, pId:1, name:"电流",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:2, pId:0, name:"专业实验题", open:true,icon:"css/zTreeStyle/img/diy/group.png"},
                { id:21, pId:2, name:"数字电路",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:22, pId:2, name:"模拟电路",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:23, pId:2, name:"集成电路",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:3, pId:0, name:"物理实验题", open:true,icon:"css/zTreeStyle/img/diy/group.png"},
                { id:31, pId:3, name:"质量",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:32, pId:3, name:"光学",icon:"css/zTreeStyle/img/diy/group.png"},
                { id:33, pId:3, name:"电磁波",icon:"css/zTreeStyle/img/diy/group.png"}
            ];
