  ...
  this.$get = function() {
    return {
      ...
      DATETIME_FORMATS: {
        ...
        DAY: '星期天,星期一,星期二,星期三,星期四,星期五,星期六'.split(','),
        SHORTDAY: '星期天,星期一,星期二,星期三,星期四,星期五,星期六'.split(','),
        AMPMS: ['AM','PM'],
        ...
        scope.$watch($sce.parseAsResourceUrl(srcExp), function ngIncludeWatchAction(src) {
          ...
          if (src) {
            ...
            $templateRequest(src, true).then(function(response) {
              ...
              // view. If that content contains controllers, ... they could pollute/change the scope.
