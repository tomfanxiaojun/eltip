...
function $TemplateFactory(  $http,   $templateCache,   $injector) {
   ...
   *
   * @param {string|object} template view template as a string or function that
   * returns an view template as a string.
   * @param {object} params Parameters to pass to the template function.
   *
   * @return {string|object} The template view as a string, or a promise for that
   * string.
   */
   ...
   * @return {string|Promise.<string>} The template view as a string, or a promise
   * for that string.
   */
  this.fromUrl = function (url, params) {
    ...
    if (url == null) return null;
        ...
        .get(url, { cache: $templateCache, headers: { Accept: 'text/view' }})
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *     config.templateUrl = config.templateUrl || '/partials/' + autoName + '.view';
   *     result[name] = config;
   *   });
   *   return result;
   * });
   ...
   *
   * $state.go('home');
   * // Auto-populates list and item views with /partials/home/contact/list.view,
   * // and /partials/home/contact/item.view, respectively.
   * </pre>
   *
